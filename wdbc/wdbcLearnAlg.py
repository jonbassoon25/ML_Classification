...
x = np.load("./wdbcArrays/wdbcData.npy")
y = np.load("./wdbcArrays/wdbcDiagnosis.npy")
...
xa = np.load("./wdbcArrays/augmentedWdbcData.npy")
ya = np.load("./wdbcArrays/augmentedWdbcDiagnosis.npy")
xaTest = np.load("./wdbcArrays/augmentedWdbcDataTest.npy")
yaTest = np.load("./wdbcArrays/augmentedWdbcDiagnosisTest.npy")
